...
SubBytesQuad: SubBytes.v FFMul4.v SubBytesQuadTestBench.v Quad.v
	$(CC) -o SubBytesQuad SubBytes.v FFMul4.v Quad.v SubBytesQuadTestBench.v
...
clean:
	rm SubBytesHamming FFMul4 SubBytesQuad
